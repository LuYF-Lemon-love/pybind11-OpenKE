...
from pybind11_ke.module.model import get_transd_hpo_config
...
# 定义模型超参数优化范围
# ---------------------------------------------------------
# :py:func:`pybind11_ke.module.model.get_transd_hpo_config` 返回了
# :py:class:`pybind11_ke.module.model.TransD` 的默认超参数优化范围。
