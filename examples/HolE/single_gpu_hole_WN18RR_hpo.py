...
from pybind11_ke.module.model import get_hole_hpo_config
...
# 定义模型超参数优化范围
# ---------------------------------------------------------
# :py:func:`pybind11_ke.module.model.get_hole_hpo_config` 返回了
# :py:class:`pybind11_ke.module.model.HolE` 的默认超参数优化范围。
...
######################################################################
# .. figure:: /_static/images/examples/HolE/HolE-WN18RR-HPO.png
#      :align: center
#      :height: 300
#
#      超参数优化结果
